...
description: Generate one or more pixel-art tiles for the Example world. Triggers when user says "generate a tile", "make a sprite for X", "regenerate Y", or asks for new world art. Reads the design template, runs the full generate→post-process→review→retry orchestrator, saves results into modules/art-pipeline/generated/tiles/, logs cost. Always reuses the locked palette and rubric in modules/art-pipeline/template/.
---
