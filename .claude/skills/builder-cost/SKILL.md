...
You are logging a cost entry on behalf of the current builder. The GDS keeps a running ledger that powers the cost-vs-value charts on `status.example.com`.
